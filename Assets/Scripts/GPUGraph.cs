...
public class GPUGraph : MonoBehaviour
{
    ...
    [SerializeField, Min(0f)] float functionDuration = 2f, transitionDuration = 2f;
    ...
    void OnEnable() {
        // reserves the memory in GPU for the positions buffer, argument 1 is the size of the buffer and 2 is the size of each element in memory
    ...
    void PickNextFunction () {
        function = transitionMode == TransitionMode.Cycle ? 
            ...
            FunctionLibrary.GetRandomNewFunctionName(function);
    }
